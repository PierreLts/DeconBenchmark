...
# Path to R script
SCRIPT="/work/gr-fe/lorthiois/DeconBenchmark/scripts/data/BE_split.R"
...
# Run R script - now passing PREFIX as third argument
Rscript ${SCRIPT} ${RLIBRARY} ${OUTPUT_DIR} ${PREFIX}

end=`date +%s`
runtime=$((end-start))
echo "Runtime: $runtime seconds"
echo "BloodExample data saved to: $OUTPUT_DIR with prefix: $PREFIX"