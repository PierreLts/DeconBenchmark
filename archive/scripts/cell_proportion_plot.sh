...
#SBATCH --job-name=cell_proportion_plot
...
SCRIPT=/work/gr-fe/lorthiois/DeconBenchmark/scripts/benchmark/cell_proportion_plot.R
GROUND_TRUTH="/work/gr-fe/lorthiois/DeconBenchmark/generated_data/ground_truth_proportions.rda"
RESULTS="/work/gr-fe/lorthiois/DeconBenchmark/deconv_results/results_BayesPrism_Batch1.rda"
