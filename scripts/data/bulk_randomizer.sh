...
#SBATCH --job-name=bulk_random_gen
...
SCRIPT="/work/gr-fe/lorthiois/DeconBenchmark/scripts/data/bulk_randomizer.R"
...
start=`date +%s`
echo "START AT $(date)"
echo "Generating randomized bulk data for prefix: $PREFIX"
...
echo "Randomized data saved to: $OUTPUT_DIR"