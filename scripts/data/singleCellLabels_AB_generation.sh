...
#SBATCH --job-name=singleCellLabels_AB_gen
...
SCRIPT="/work/gr-fe/lorthiois/DeconBenchmark/scripts/data/singleCellLabels_AB_generation.R"
...
start=`date +%s`
echo "START AT $(date)"
echo "Filtering labels by sample type: $SAMPLE_FILTER"
...
echo "Cell labels saved to: $OUTPUT_DIR with prefix $PREFIX and filter $SAMPLE_FILTER"